  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav
        ...
        style={{ borderBottom: "1px solid #ccc3d8" }}
      >
        <span className="font-bold text-xl" style={{ color: "#630ed4" }}>
          Medi-Q
        </span>
      ...
      <div className="max-w-xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-500 text-sm mb-6">
          Check-in quickly and save your spot at the clinic without waiting in
          line.
        </p>

        {/* Clinic Image */}
        <div
          className="w-full h-48 rounded-2xl mb-8 flex items-center justify-center text-gray-400"
        ...
        {token && (
          <div
            className="mt-4 =-4 mb-4 py-5 rounded-xl text-center"
            style={{ background: "#f3ebfa", border: "1px solid #ede9fb" }}
          >
        ...
        >
          ...
          <p className="text-sm text-gray-600">
            By joining, you'll receive real-time updates about your status via
            SMS.
          </p>
        </div>
      </div>
